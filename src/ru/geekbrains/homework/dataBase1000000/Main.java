package ru.geekbrains.homework.dataBase1000000;
...
public class Main {
    ...
    public static void main(String[] args) {
       ...
       solidArrayInput(10000000);
        System.out.println(System.currentTimeMillis()-t + "ms - Перебор в один поток");
        long s =System.currentTimeMillis();
       splitArrayInput(10000000);
        System.out.println(System.currentTimeMillis()-s+"ms - Перебор в два потока");
        System.out.println(System.currentTimeMillis()-t+"ms - итого затрачено времени на перебор 2-мя методами");// Вот тут интересно почему разница возникает такая большая
    }
